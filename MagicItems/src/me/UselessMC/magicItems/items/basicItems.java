...
public class basicItems {
	...
	public static ItemStack genieLamp;
	...
	public static void createGenieLamp() {
		ItemStack item = new ItemStack(Material.BLUE_CANDLE);
		ItemMeta m = item.getItemMeta();
		m.setDisplayName("Genie Lamp");
		List<String> lore = new ArrayList<>();
		lore.add("Right click to summon a genie and get 3 wishes");
		m.setLore(lore);
		item.addUnsafeEnchantment(Enchantment.PROTECTION_ENVIRONMENTAL, 5);
		m.addItemFlags(ItemFlag.HIDE_ENCHANTS);
		item.setItemMeta(m);
